...
import data from "../data/ocorrencias-summary-2024.json";
import data2025Comparacao from "../data/ocorrencias-summary.json";
import {
  Bar,
  BarChart,
  CartesianGrid,
...
export default function DashboardOcorrencias2024({
  modo = "painel",
    ...
    <main className={`page dashboard-page ${isAnoPendente ? "is-route-changing" : ""}`}>
      ...
      <section className="hero-card operational-legend-line" aria-label="Legenda operacional">
        ...
        <div className="dashboard-legend-sections">
          <section className="dashboard-legend-section" aria-labelledby="operational-status-legend-title-2024">
            <h3 id="operational-status-legend-title-2024">Estados operacionais</h3>
          ...
          <section className="dashboard-legend-section" aria-labelledby="line-legend-title-2024">
            <h3 id="line-legend-title-2024">Linhas</h3>
